...
function TestimonialCard({
  ...
  return (
    <article className="border-border bg-card flex flex-col rounded-2xl border p-6 transition-shadow hover:shadow-md">
      {/* Header */}
      ...
      {/* Content */}
      <p className="text-text-secondary flex-1">{text}</p>
